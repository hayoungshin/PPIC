...
<style>
    ...
    /* 승인, 참조 modal */
    .a-content-1, .r-content-1, .u-content-1{
		height: 300px; 
		width: 250px; 
		float: left; 
		overflow: auto;
	}
    .a-content-1::-webkit-scrollbar, .r-content-1::-webkit-scrollbar, .u-content-1::-webkit-scrollbar{
		width: 8px;
	}
    .a-content-1::-webkit-scrollbar-thumb, .r-content-1::-webkit-scrollbar-thumb, .u-content-1::-webkit-scrollbar-thumb{
		background: lightgray; 
		border-radius: 10px;
	}
    .a-content-2, .r-content-2, .u-content-2{
		border: 1px solid lightgray; 
		margin-left: 10px; 
		height: 300px; 
		width: 200px; 
    ...
    .a-content-2::-webkit-scrollbar, .r-content-2::-webkit-scrollbar, .u-content-2::-webkit-scrollbar{
		width: 8px;
	}
    .a-content-2::-webkit-scrollbar-thumb, .r-content-2::-webkit-scrollbar-thumb, .u-content-2::-webkit-scrollbar-thumb{
		background: lightgray; 
		border-radius: 10px;
	}
	                            ...
	                            <tr>
	                                <td colspan="6">
	                                    ...
	                                    <table id="tb" class="table-bordered">
	                                        ...
	                                        <tbody id="u-person-content"></tbody>
	                                    </table>
