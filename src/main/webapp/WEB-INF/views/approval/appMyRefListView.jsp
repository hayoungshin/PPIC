...
<body>
	...
	<script>
		window.onload = function(){
			...
			document.getElementById("menu-1-2").style = 'color:black; font-weight:600';

			document.getElementById("menu-1-2").innerHTML += " <span style='color:#fdbaba;'>${pi.listCount}</span>";
