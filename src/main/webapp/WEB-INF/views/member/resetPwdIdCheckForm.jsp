...
<body>
	...
	<div id="wrapper" align="center" style="margin-top:300px;">
        ...
        <form action="resetPwdIdCheck.me" method="post">
            <table>
                <tr>
                    <td>
                        <div>
                            <img src="resources/icons/email.png" width="25px" style="vertical-align:middle;">
                            <input type="text" name="userId" placeholder="아이디" style="width:210px; height:90%; margin-left:5px; border: none;" required></input>
                        </div>
                    </td>
                </tr>
            </table>
